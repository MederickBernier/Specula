...
return [
    ...
    */
    ...
    'options' => [
        ...
        /**
         * Embed only the glyphs a document actually uses.
         *
         * Without this every PDF carries the whole DejaVu family: a one page
         * decision record weighs 1.2MB rather than 29KB. Subsetting keeps full
         * Unicode, which the core fonts would not, and the related-decisions
         * table uses arrows that Latin-1 cannot represent.
         */
